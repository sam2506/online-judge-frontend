...
import BeforeContest from "../BeforeContest/BeforeContest";
    ...
    fetchContest() {
        ...
        axios.get(JUDGE_DOMAIN + "/contests/" + contestId, axiosConfig)
            .then(res => {
                ...
                console.log(contest);
                var isContestStarted = true;
                if(new Date(contest.startTime) > new Date()) {
                    isContestStarted = false;
                }
                this.setState({contest: contest, loading: false, isContestStarted: isContestStarted});
            }).catch((err) => {
                console.log(err);
            ...
            <div>
                ...
                (<div className="col-10 offset-1">
                    ...
                    (<div>
                        ...
                        </div>) : <BeforeContest contest={this.state.contest}/>
                        }
                    </div>) : <NotFound/>
                    }
                </div>) : <Loading />
